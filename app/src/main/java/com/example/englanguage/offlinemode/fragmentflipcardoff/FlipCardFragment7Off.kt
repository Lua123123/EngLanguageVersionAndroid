...
import com.example.englanguage.databinding.FragmentFlipCard7OffBinding
...
class FlipCardFragment7Off : Fragment() {
    lateinit var frontAnim: AnimatorSet
    lateinit var behindAnim: AnimatorSet
    private var isFront = true
    private lateinit var binding: FragmentFlipCard7OffBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_flip_card7_off, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (mListVocabulary.isNotEmpty()) {
            ...
            binding.mButtonSpeak.setOnClickListener {
                val text: String = mListVocabulary[36].word
                speak(text)
            }
            binding.mButtonSpeak1.setOnClickListener {
                val text1: String = mListVocabulary[37].word
                speak(text1)
            }
            binding.mButtonSpeak2.setOnClickListener {
                val text2: String = mListVocabulary[38].word
                speak(text2)
            }
            binding.mButtonSpeak3.setOnClickListener {
                val text3: String = mListVocabulary[39].word
                speak(text3)
            }
            binding.mButtonSpeak4.setOnClickListener {
                val text4: String = mListVocabulary[40].word
                speak(text4)
            }
            binding.mButtonSpeak5.setOnClickListener {
                val text5: String = mListVocabulary[41].word
                speak(text5)
            }

            binding.cartFront.text = mListVocabulary[36].word
            binding.cartBehind.text = mListVocabulary[36].mean
            binding.cartFront1.text = mListVocabulary[37].word
            binding.cartBehind1.text = mListVocabulary[37].mean
            binding.cartFront2.text = mListVocabulary[38].word
            binding.cartBehind2.text = mListVocabulary[38].mean
            binding.cartFront3.text = mListVocabulary[39].word
            binding.cartBehind3.text = mListVocabulary[39].mean
            binding.cartFront4.text = mListVocabulary[40].word
            binding.cartBehind4.text = mListVocabulary[40].mean
            binding.cartFront5.text = mListVocabulary[41].word
            binding.cartBehind5.text = mListVocabulary[41].mean
        }
    }
