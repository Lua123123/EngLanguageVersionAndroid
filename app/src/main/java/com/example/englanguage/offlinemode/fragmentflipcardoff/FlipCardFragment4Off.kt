...
import com.example.englanguage.databinding.FragmentFlipCard4OffBinding
...
class FlipCardFragment4Off : Fragment() {
    private lateinit var frontAnim: AnimatorSet
    private lateinit var behindAnim: AnimatorSet
    private var isFront = true
    private lateinit var binding: FragmentFlipCard4OffBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_flip_card4_off, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (mListVocabulary.isNotEmpty()) {
            ...
            binding.mButtonSpeak.setOnClickListener {
                val text: String = mListVocabulary[18].word
                speak(text)
            }
            binding.mButtonSpeak1.setOnClickListener {
                val text1: String = mListVocabulary[19].word
                speak(text1)
            }
            binding.mButtonSpeak2.setOnClickListener {
                val text2: String = mListVocabulary[20].word
                speak(text2)
            }
            binding.mButtonSpeak3.setOnClickListener {
                val text3: String = mListVocabulary[21].word
                speak(text3)
            }
            binding.mButtonSpeak4.setOnClickListener {
                val text4: String = mListVocabulary[22].word
                speak(text4)
            }
            binding.mButtonSpeak5.setOnClickListener {
                val text5: String = mListVocabulary[23].word
                speak(text5)
            }

            binding.cartFront.text = mListVocabulary[18].word
            binding.cartBehind.text = mListVocabulary[18].mean
            binding.cartFront1.text = mListVocabulary[19].word
            binding.cartBehind1.text = mListVocabulary[19].mean
            binding.cartFront2.text = mListVocabulary[20].word
            binding.cartBehind2.text = mListVocabulary[20].mean
            binding.cartFront3.text = mListVocabulary[21].word
            binding.cartBehind3.text = mListVocabulary[21].mean
            binding.cartFront4.text = mListVocabulary[22].word
            binding.cartBehind4.text = mListVocabulary[22].mean
            binding.cartFront5.text = mListVocabulary[23].word
            binding.cartBehind5.text = mListVocabulary[23].mean
        }
    }
