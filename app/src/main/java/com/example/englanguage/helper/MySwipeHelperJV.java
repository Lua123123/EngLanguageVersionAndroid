...
public abstract class MySwipeHelperJV extends ItemTouchHelper.SimpleCallback {
    ...
    public MySwipeHelperJV(Context context, RecyclerView recyclerView, int buttonWidth) {
    ...
    public class MyButton {
        ...
        public MyButton(int gravity, Context context, String text, int textSize, int imageResId, int color, MyButtonClickListener listener) {
