...
class FlipCardFragment5 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.mButtonSpeak.setOnClickListener {
            val text: String? = flipViewModel.mVocabulary.value?.success?.get(24)?.word
            speak(text!!) }
        binding.mButtonSpeak1.setOnClickListener {
            val text1: String? = flipViewModel.mVocabulary.value?.success?.get(25)?.word
            speak(text1!!) }
        binding.mButtonSpeak2.setOnClickListener {
            val text2: String? = flipViewModel.mVocabulary.value?.success?.get(26)?.word
            speak(text2!!) }
        binding.mButtonSpeak3.setOnClickListener {
            val text3: String? = flipViewModel.mVocabulary.value?.success?.get(27)?.word
            speak(text3!!) }
        binding.mButtonSpeak4.setOnClickListener {
            val text4: String? = flipViewModel.mVocabulary.value?.success?.get(28)?.word
            speak(text4!!) }
        binding.mButtonSpeak5.setOnClickListener {
            val text5: String? = flipViewModel.mVocabulary.value?.success?.get(29)?.word
            speak(text5!!) }
        ...
        {
            binding.cartFront.text = it!!.success?.get(24)?.word
            binding.cartBehind.text = it.success?.get(24)?.mean
            binding.cartFront1.text = it.success?.get(25)?.word
            binding.cartBehind1.text = it.success?.get(25)?.mean
            binding.cartFront2.text = it.success?.get(26)?.word
            binding.cartBehind2.text = it.success?.get(26)?.mean
            binding.cartFront3.text = it.success?.get(27)?.word
            binding.cartBehind3.text = it.success?.get(27)?.mean
            binding.cartFront4.text = it.success?.get(28)?.word
            binding.cartBehind4.text = it.success?.get(28)?.mean
            binding.cartFront5.text = it.success?.get(29)?.word
            binding.cartBehind5.text = it.success?.get(29)?.mean
        }
    }
